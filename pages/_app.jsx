      ...
      <div className="bg-neutral-800/5">
        <div className="max-w-screen-lg p-5 w-full md:w-10/12 lg:w-8/12 mx-auto transition-all duration-300">
          <div className="md:flex w-full items-center justify-between">
            <div>
              <p>Copyright &copy; 2022 ❤️</p>
              <a href="https://github.com/turkerpw/turker.vercel.app" target="_blank" rel="noreferrer" className="hover:text-red-500 transition-all duration-200">Sitenin açık kaynaklı hali ❤️</a>
            </div>
            <div className="mt-2 md:mt-0 flex items-center">
              <a className="w-full md:w-auto bg-neutral-700/5 hover:bg-neutral-700/20 px-4 py-2 rounded-md transition-all duration-200">
